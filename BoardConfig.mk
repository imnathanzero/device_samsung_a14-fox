...
TARGET_SOC := s5e3830
TARGET_BOOTLOADER_BOARD_NAME := s5e3830
...
BOARD_MKBOOTIMG_ARGS += --header_version $(BOARD_BOOT_HEADER_VERSION) --pagesize $(BOARD_KERNEL_PAGESIZE) --board "SRPVK04A001"
...
BOARD_RECOVERYIMAGE_PARTITION_SIZE := 108003328

# Dynamic Partitions
BOARD_SUPER_PARTITION_SIZE := 7717519360
BOARD_SUPER_PARTITION_GROUPS := samsung_dynamic_partitions
BOARD_SAMSUNG_DYNAMIC_PARTITIONS_SIZE := 7713325056
...
TW_DEVICE_VERSION := Samsung Galaxy A14 4G (Exynos)
