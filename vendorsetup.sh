...
export FOX_TARGET_DEVICES="a14, SM-A145M, SM-A145F"
export TARGET_DEVICE_ALT="a14,  SM-A145M, SM-A145F"
export FOX_BUILD_DEVICE="a14, SM-A145M, SM-A145F"
...
export_build_vars() {
    ...
    export FOX_DELETE_INITD_ADDON=0  # Note: This can cause bootloops
...
set_env_var() {
    ...
    echo " export CURR_DEVICE=a14"
    exit 1
}

# Function to handle mismatched CURR_DEVICE variable
var_not_eq() {
    echo -e "${RED_BACK}CURR_DEVICE not equal to a14${RESET}"
    ...
    echo -e "${RED}Skipping a14 specific build vars...${RESET}"
}
